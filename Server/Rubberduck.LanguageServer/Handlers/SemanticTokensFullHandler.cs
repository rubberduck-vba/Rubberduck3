...
namespace Rubberduck.LanguageServer.Handlers
{
    public class SemanticTokensFullHandler : SemanticTokensFullHandlerBase
    {
        ...
        public SemanticTokensFullHandler(ILanguageServerFacade server, SupportedLanguage language, DocumentContentStore contentStore)
        {
            _language = language;
            _server = server;
        ...
        public async override Task<SemanticTokens?> Handle(SemanticTokensParams request, CancellationToken cancellationToken)
        {
