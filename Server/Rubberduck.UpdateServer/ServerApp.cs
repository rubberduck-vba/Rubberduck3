...
namespace Rubberduck.UpdateServer
{
    public sealed class ServerApp : IDisposable
    {
        ...
        private UpdateServerState _serverState = default!;
        ...
        public async Task RunAsync()
        {
            try
            {
                ...
                services.AddSingleton<IDefaultSettingsProvider<UpdateServerSettingGroup>>(provider => UpdateServerSettingGroup.Default);
                services.AddSingleton<ISettingsProvider<UpdateServerSettingGroup>, SettingsService<UpdateServerSettingGroup>>();
                ConfigureServices(services);

                _serviceProvider = services.BuildServiceProvider();
                _logger = _serviceProvider.GetRequiredService<ILogger<ServerApp>>();
                _serverState = _serviceProvider.GetRequiredService<UpdateServerState>();
        ...
        private void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IHealthCheckService<UpdateServerSettingGroup>, ClientProcessHealthCheckService<UpdateServerSettingGroup>>();
        }
        ...
        private void ConfigureLogging(ILoggingBuilder builder)
        {
            builder.AddNLog(provider =>
            {
                ...
                {
                    builder.LoadConfigurationFromFile("NLog-update-server.config");
                });
        ...
        private void ConfigureServer(LanguageServerOptions options)
        {
            ...
            loggerProvider.LogFactory.Setup().LoadConfigurationFromFile("NLog-update-server.config");
