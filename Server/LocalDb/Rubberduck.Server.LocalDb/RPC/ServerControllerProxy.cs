...
{
    /*
    public class ServerControllerProxy : JsonRpcService, ILocalDbServerController
    {
        private readonly IEnvironmentService _environment;
        private readonly LocalDbServer _server;

        internal ServerControllerProxy(IEnvironmentService environment, LocalDbServer server)
        {
