...
public static class Tokens
{
    ...
    public static readonly string PowerOp = "^";
    public static readonly string NegationOp = "-";
    public static readonly string AdditionOp = "+";
    public static readonly string SubtractionOp = "-";
    public static readonly string MultiplicationOp = "*";
    public static readonly string DivisionOp = "/";
    public static readonly string IntegerDivisionOp = "\\";
    public static readonly string ModuloOp = $"{Mod}";
    public static readonly string ConcatOp = "&";
    public static readonly string CompareEqualOp = "=";
    public static readonly string CompareNotEqualOp = "<>";
    public static readonly string CompareLikeOp = $"{Like}";
    public static readonly string CompareIsOp = $"{Is}";
    public static readonly string CompareGreaterThanOp = ">";
    public static readonly string CompareGreaterThanOrEqualOp = ">=";
    public static readonly string CompareLessThanOp = "<";
    public static readonly string CompareLessThanOrEqualOp = "<=";
    public static readonly string LogicalNotOp = $"{Not}";
    public static readonly string LogicalAndOp = $"{And}";
    public static readonly string LogicalOrOp = $"{Or}";
    public static readonly string LogicalXOrOp = $"{XOr}";
    public static readonly string LogicalEqvOp = $"{Eqv}";
    public static readonly string LogicalImpOp = $"{Imp}";
}
