...
namespace Rubberduck.InternalApi.Model.Declarations.Types.Abstract
{
    ...
    {
        protected VBType(string name, bool isUserDefined = false)
            : base(typeof(TValue), name, isUserDefined)
        {
        }
    ...
    public abstract record class VBType
    {
        ...
        public VBType(Type? managedType, string name, bool isUserDefined = false)
        {
