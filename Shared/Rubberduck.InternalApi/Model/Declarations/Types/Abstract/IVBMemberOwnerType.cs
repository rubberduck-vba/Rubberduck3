...
namespace Rubberduck.InternalApi.Model.Declarations.Types.Abstract
{
    ...
    public abstract record class VBTypeMember 
    {
        ...
        /// </summary>
        protected VBTypeMember(Uri uri, string name, RubberduckSymbolKind kind, Accessibility accessibility, Symbol? declaration = null, Symbol[]? definitions = null, bool isUserDefined = false)
        {
            Uri = uri;
