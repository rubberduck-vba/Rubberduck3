...
namespace Rubberduck.InternalApi.Model.Declarations.Types.Abstract
{
    public abstract record class VBReturningMember : VBTypeMember
    {
        ...
        public VBReturningMember(Uri uri, string name, RubberduckSymbolKind kind, Accessibility accessibility, Symbol? declaration = null, Symbol[]? definitions = null, bool isUserDefined = false, VBType? type = null) 
