...
namespace Rubberduck.InternalApi.Model.Declarations.Types
{
    public record class VBPropertyGetMember : VBReturningMember
    {
        ...
        public VBPropertyGetMember(Uri uri, string name, RubberduckSymbolKind kind, Accessibility accessibility, Symbol? declaration = null, Symbol[]? definitions = null, bool isUserDefined = false, VBType? type = null)
