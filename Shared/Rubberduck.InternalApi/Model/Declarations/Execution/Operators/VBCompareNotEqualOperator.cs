...
{
    public VBCompareNotEqualOperator(WorkspaceUri parentUri, string lhsExpression, string rhsExpression, TypedSymbol? lhs = null, TypedSymbol? rhs = null)
        : base(Tokens.CompareNotEqualOp, parentUri, lhsExpression, rhsExpression, lhs, rhs)
    {
    }
